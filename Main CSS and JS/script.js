...
// This line of code helps with flashing elements and styles when loading to another page
var pageLoad = (callagain) => {
    // checks if the content already is loaded or ready for interaction
    if (document.readyState === 'interactive' || document.readyState === 'complete') {
        // if the page is ready, it will then call the pageLoad function
        callagain();
    }
    else {
        // if the page isn't ready we add an event listener DOMContentLoaded event which basically checks again to see if the content is loaded
        document.addEventListener('DOMContentLoaded', callagain);
    }
};

// callagain function when DOM content is loaded
pageLoad(() => {
    // set the body's visibility to visible again
